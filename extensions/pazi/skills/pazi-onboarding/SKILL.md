...
Read both files before saying anything.
...
**Before composing the message**, read IDENTITY.md (your name) and USER.md (user's name), and look at the **agent's name** (from IDENTITY.md) to understand what this agent is for.
