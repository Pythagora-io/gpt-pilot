...
class ViteReactProjectTemplate(BaseProjectTemplate):
    ...
    file_descriptions = {
        ...
        "client/src/components/theme-toggle.tsx": "Theme toggle component for switching between light and dark modes.",
        ...
        "client/src/hooks/use-mobile.tsx": "Custom hook for detecting mobile viewport.",
        "client/src/hooks/use-toast.ts": "Custom hook for managing toast notifications.",
        "client/src/hooks/use-theme.ts": "Custom hook for managing theme state and toggling between light and dark modes.",
