...
class ViteReactProjectTemplate(BaseProjectTemplate):
    ...
    file_descriptions = {
        ...
        "client/src/components/themeToggle.tsx": "Theme toggle component for switching between light and dark modes.",
        ...
        "client/src/hooks/useTheme.ts": "Custom hook for managing theme state and toggling between light and dark modes.",
