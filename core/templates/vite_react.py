...
class ViteReactProjectTemplate(BaseProjectTemplate):
    ...
    file_descriptions = {
        ...
        "client/src/components/theme-provider.tsx": "Theme provider component for managing light and dark mode themes.",
