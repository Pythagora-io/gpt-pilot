...
DEV_STEPS = {
    'definitions': [
        ...
        {
            'name': 'get_files',
            'description': 'Returns development files that are currently implemented so that they can be analyzed and so that changes can be appropriately made.',
            'parameters': {
                'type': 'object',
                'properties': {
                    'files': {
                        ...
                        'items': {
                            'type': 'string',
                            'description': 'A single file name that needs to be analyzed to implement the reqired changes. Remember, this is a file name with path relative to the project root. For example, if a file path is `{{project_root}}/models/model.py`, this value needs to be `models/model.py`.',
                        }
                    }
                },
                'required': ['files'],
