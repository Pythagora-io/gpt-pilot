...
class TestDeveloper:
    ...
    @patch('helpers.AgentConvo.get_saved_development_step')
    @patch('helpers.AgentConvo.save_development_step')
    def test_implement_task_with_llm(self, mock_save, mock_get_saved_step):
        # Given a project
        project = create_project()
        project.project_description = 'The chat_app is a web-based application designed for teenagers who want to ' \
                                      'communicate with each other through group chats and direct messages. ' \
                                      'The target audience\'s needs and expectations are not specified. Currently, ' \
                                      'there are no specific features or functionalities requested for the chat_app.'
        # with a plan generated by mistralai/mistral-7b-instruct
        project.development_plan = [
            {
                "description": "Set up the project environment",
                "programmatic_goal": "The project environment needs to be set up with Node.js, MongoDB, Mongoose, Bootstrap, and Socket.io installed and configured.",
                "user_review_goal": "The developer should be able to confirm that all required technologies are installed and configured."
            }, {
                "description": "Create the server-side code",
                "programmatic_goal": "The server-side code needs to be created using Node.js and Express, with routes for group chats and direct messages.",
                "user_review_goal": "The developer should be able to confirm that the server-side code is working as expected and can be accessed through the URL `http://localhost:3000/`."
            }, {
                "description": "Create the database schema",
                "programmatic_goal": "The database schema needs to be created using MongoDB and Mongoose, with tables for users, groups, and messages.",
                "user_review_goal": "The developer should be able to confirm that the database schema is working as expected and can be accessed through the URL `http://localhost:3000/`."
            }, {
                "description": "Create the client-side code",
                "programmatic_goal": "The client-side code needs to be created using Bootstrap and Socket.io, with UI elements for group chats and direct messages.",
                "user_review_goal": "The developer should be able to confirm that the client-side code is working as expected and can be accessed through the URL `http://localhost:3000/`."
            }, {
                "description": "Test the app",
                "programmatic_goal": "The app needs to be tested using automated tests to ensure that all features and functionalities are working as expected.",
                "user_review_goal": "The developer should be able to confirm that the app is working as expected and can be accessed through the URL `http://localhost:3000/`."
            }, {
                "description": "Deploy the app",
                "programmatic_goal": "The app needs to be deployed to a production environment, with a URL accessible to the target audience.",
                "user_review_goal": "The developer should be able to confirm that the app is deployed and accessible to the target audience."
            }]
        project.architecture = ['Node.js', 'MongoDB', 'Mongoose', 'Bootstrap', 'Socket.io'],
        project.get_all_coded_files = lambda: []
        project.current_step = 'test'
        ...
        # When
        developer.implement_task(1, project.development_plan[1])
